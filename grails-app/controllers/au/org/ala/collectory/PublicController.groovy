...
class PublicController {
    ...
    // CESP BENIN - FRANCE 2017 : /datasetsBenin will now show only Beninese datasets
    def dataSetsBenin = {
        forward(action: 'datasetsBenin')
    }
    ...
    def resourcesFrance = {
        ...
        def drs = DataResource.findAllByStatusNotEqualAndPublishingCountry('declined', 'FR', [sort:'name']).collect {
