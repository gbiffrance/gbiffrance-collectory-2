 ...
 */
    ...
    def create = {
        ...
        def publishingCountry = params.publishingCountry ?: message(code: "provider.group.controller.14", default: "FR")
        ...
        switch (entityName) {
            ...
            case Institution.ENTITY_TYPE:
                pg = new Institution(uid: idGeneratorService.getNextInstitutionId(), name: name, publishingCountry: publishingCountry, userLastModified: collectoryAuthService?.username()); break
            case DataProvider.ENTITY_TYPE:
                pg = new DataProvider(uid: idGeneratorService.getNextDataProviderId(), name: name, publishingCountry: publishingCountry, userLastModified: collectoryAuthService?.username()); break
            case DataResource.ENTITY_TYPE:
                pg = new DataResource(uid: idGeneratorService.getNextDataResourceId(), name: name, publishingCountry: publishingCountry, userLastModified: collectoryAuthService?.username())
