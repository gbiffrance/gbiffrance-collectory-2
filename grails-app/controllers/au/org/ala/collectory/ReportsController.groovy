...
class ReportsController {
    ...
    def classification = {
        ...
        def plants = 0; def fauna = 0; def entomology = 0; def microbes = 0; def fungus = 0; def paleontology = 0;
        list.each {
            ...
            if (Classification.matchKeywords(it.keywords, 'fungus')) { fungus++ }
            if (Classification.matchKeywords(it.keywords, 'paleontology')) { paleontology++ }
        }
        [collections: list, plants: plants, fauna: fauna, entomology: entomology, microbes: microbes, fungus: fungus, paleontology: paleontology]
    }
