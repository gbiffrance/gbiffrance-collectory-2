    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                ...
                %{-- CESP GBIF BENIN - GBIF FRANCE : Correction bug création d'un providermap - format --}%
                <td valign="top" class="value"><g:formatDate format="yyyy-MM-dd" date="${providerMapInstance?.lastUpdated}" /></td>
            ...
            <tr class="prop">
                ...
                %{-- CESP GBIF BENIN - GBIF FRANCE : Correction bug création d'un providermap - format --}%
                <td valign="top" class="value"><g:formatDate format="yyyy-MM-dd" date="${providerMapInstance?.dateCreated}" /></td>
