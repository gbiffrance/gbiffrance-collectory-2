...
<div class="list">
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <g:sortableColumn property="publishingCountry" title="${message(code: 'dataResource.publishingCountry.label', default: 'Publishing Country')}" />
        ...
        <g:each in="${institutionInstanceList}" status="i" var="institutionInstance">
            <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                ...
                <td>
                    ${fieldValue(bean: institutionInstance, field: "publishingCountry")}
                </td>
