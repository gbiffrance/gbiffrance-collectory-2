...
<head>
    ...
    <r:require modules="gbiffrance_collectory_css, google-maps-api,bigbuttons,bbq,openlayers,map"/>
</head>
        ...
        <div class="col-md-4">
            <div class="section filter-buttons">
                ...
                <div class="fungis" id="fungis" onclick="toggleButton(this);return false;">
                    <h2><a href="" class="filtre-meta"><g:message code="public.map3.link.fungus" /><span><g:message code="public.map3.link.fungi" />.</span></a></h2>
                </div>
                ...
                <div class="paleontology" id="paleontology" onclick="toggleButton(this);return false;">
                    <h2><a href="" class="filtre-meta"><g:message code="public.map3.link.paleontology" /><span><g:message code="public.map3.link.paleontologies" />.</span></a></h2>
                </div>
            </div><!--close section-->
