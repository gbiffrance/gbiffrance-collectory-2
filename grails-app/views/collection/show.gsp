...
<div class="dialog emulate-public">
    ...
    <!-- Collection types -->
        ...
        <g:if test="${!instance.listKeywords().contains('fungus')}">
            (<g:link action="addKeyword" id="${instance.id}" params="[keyword:'fungus']"><g:message code="collection.show.link.addfungus" /></g:link>)
        </g:if>
        ...
        <g:if test="${!instance.listKeywords().contains('microbes')}">
            (<g:link action="addKeyword" id="${instance.id}" params="[keyword:'paleontology']"><g:message code="collection.show.link.addfossil" /></g:link>)
        </g:if>
        </p>
    ...
    <!-- taxonomy hints -->
    <g:render template="/plugins/collectory-1.9.2-SNAPSHOT/grails-app/views/shared/taxonomyHints" model="[instance: instance]"/>
