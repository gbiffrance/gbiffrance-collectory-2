<g:set var="orgNameLong" value="${grailsApplication.config.skin.togo.orgNameLong}"/>
<g:set var="orgNameShort" value="${grailsApplication.config.skin.togo.orgNameShort}"/>
<!DOCTYPE html>
<html>
<head>
    ...
    <g:set var="favicon" value="${grailsApplication.config.skin.togo.favicon}"/>
    <link href="${favicon}" rel="shortcut icon"  type="image/x-icon"/>
    <g:set var="togoBaseURL" value="${grailsApplication.config.headerAndFooter.togo.baseURL}"/>
    <link href="${togoBaseURL}/css/ala-styles.css" rel="stylesheet" type="text/css"/>
    ...
    <title>${pageProperty(name: 'title').split('\\|')[0].decodeHTML()} | Atlas of Living Togo</title>
    ...
    <r:script type="text/javascript" disposition="head">
          ...
          jQuery(function(){
            ...
            $(function(){
                $("#header").load("${togoBaseURL}/banner.html");
                $("#footer").load("${togoBaseURL}/footer.html");
            })
    </r:script>
    ...
    <r:require modules="datasets_togo_css, jquery, jquery-migration, jquery_i18n, bootstrap,  application, collectory" />
                ...
                <div class="row row-breadcrumb">
                    <nav aria-label="Breadcrumb" role="navigation">
                        <ul class="breadcrumb-list">
                            <li><a href="${grailsApplication.config.gbiftogo.baseURL ?: 'https://gbif.univ-lome.tg/'}">Accueil</a></li>
