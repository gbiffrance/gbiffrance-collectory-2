        ...
        <table class="table table-striped table-bordered">
            ...
            <g:each var='c' in="${collections}" status="i">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td style="text-align:center;"><cl:reportClassification keywords="${c.keywords}" filter="fungus"/></td>
                    ...
                    <td style="text-align:center;"><cl:reportClassification keywords="${c.keywords}" filter="paleontology"/></td>
                </tr>
            </g:each>
            <tr>
